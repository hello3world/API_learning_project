...
@router.get(
    ...
    summary="Get miner metrics history",
    responses={
...
@router.post(
    ...
    summary="Submit a metric snapshot",
    responses={
...
@router.get(
    "/latest",
    response_model=MetricResponse,
    summary="Get latest metric for a miner",
    responses={
...
async def get_latest_metric(
    ...
    **Response 404:** Miner not found or no metrics recorded yet.
    ...
    if metric is None:
        raise NotFoundException("Metric", f"No metrics found for miner {miner_id}")
...
@router.delete(
    ...
    summary="Delete metrics by date range",
    responses={
