...
@router.get(
    ...
    summary="GET /api/v1/farms - List all mining farms",
    responses={
...
@router.post(
    ...
    summary="POST /api/v1/farms - Create a new mining farm",
    responses={
...
@router.get(
    "/{farm_id}",
    response_model=FarmResponse,
    summary="GET /api/v1/farms/{farm_id} - Get a mining farm by ID",
    responses={
...
@router.put(
    "/{farm_id}",
    response_model=FarmResponse,
    summary="PUT /api/v1/farms/{farm_id} - Full update of a mining farm",
    responses={
...
@router.patch(
    "/{farm_id}",
    response_model=FarmResponse,
    summary="PATCH /api/v1/farms/{farm_id} - Partial update of a mining farm",
    responses={
        200: {"description": "Farm updated successfully"},
        401: {"description": "Not authenticated"},
        403: {"description": "Insufficient permissions"},
...
@router.delete(
    ...
    summary="DELETE /api/v1/farms/{farm_id} - Delete a mining farm",
    responses={
...
@router.get(
    ...
    summary="GET /api/v1/farms/{farm_id}/summary - Get farm aggregated statistics",
    responses={
