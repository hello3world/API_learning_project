...
@router.get(
    ...
    summary="GET /api/v1/alerts - List alerts with filters",
    responses={
...
@router.post(
    ...
    summary="POST /api/v1/alerts - Create a manual alert",
    responses={
...
@router.get(
    "/{alert_id}",
    response_model=AlertResponse,
    summary="GET /api/v1/alerts/{alert_id} - Get an alert by ID",
    responses={
...
@router.patch(
    ...
    response_model=AlertResponse,
    summary="PATCH /api/v1/alerts/{alert_id}/acknowledge - Acknowledge an alert",
    responses={
...
@router.delete(
    ...
    summary="DELETE /api/v1/alerts/{alert_id} - Delete an alert",
    responses={
